namespace CalculateLetterGrade
{
    partial class frmCalculateGrade
    {
        ...
        private void InitializeComponent()
        {
            ...
            // txtNumberGrade
            // 
            txtNumberGrade.Location = new Point(169, 27);
            txtNumberGrade.Margin = new Padding(2, 3, 2, 3);
            txtNumberGrade.Name = "txtNumberGrade";
            txtNumberGrade.Size = new Size(121, 27);
            txtNumberGrade.TabIndex = 1;
            txtNumberGrade.TextChanged += txtNumberGrade_TextChanged;
            // 
            // txtLetterGrade
            // 
            txtLetterGrade.Location = new Point(169, 63);
            txtLetterGrade.Margin = new Padding(2, 3, 2, 3);
            txtLetterGrade.Name = "txtLetterGrade";
            txtLetterGrade.ReadOnly = true;
            txtLetterGrade.Size = new Size(121, 27);
            ...
            // btnCalculate
            // 
            btnCalculate.Location = new Point(46, 113);
            ...
            // btnExit
            // 
            btnExit.Location = new Point(205, 113);
